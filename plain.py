...
def min_batch_k_means(features_data, k:int, restarts:int, epsilon:float, batch_size:int):
    ...
    for restart in range(restarts):
        ...
        while no_change < patience:
            ...
            assigned_centroids = assign_centroids(batch, centroids) # same function as in kmeans
            ...
            diff = mean_distance(centroids, new_centroids) # we can use euclidean distance
